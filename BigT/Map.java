...
public class Map implements GlobalConst{
    ...
    */
    public Map(byte[] amap, int offset) throws IOException {
        //System.out.println("amap "+amap+"offset"+offset);
        this.map = amap;
...
//        this.map_length = this.map.length;
    ...
    */
    ...
    public byte [] getMapByteArray(){
        //System.out.println("getMapByteArray, offset:"+map_offset+", map length:"+map_length);
...
//    }
    ...
    {
//        //System.out.println("returnMapByteArray");
//        byte [] tuplecopy = new byte [this.map_length];
//        System.arraycopy(this.map, this.map_offset, tuplecopy, 0, this.map_length);
        return this.map;
    }
    ...
    public void setByteData(byte[] data) throws IOException {
        //System.out.println("setByteData");
        this.map = data;
        initFieldOffset();
    ...
    {
        //System.out.println(" getOffset:"+this.map_offset+"fldcnt: "+fldCnt);
        for(int i=0;i<fldCnt;i++){
            //System.out.println("i:"+i+" offset:"+fldOffset[i] );
        }
    ...
    {
        //System.out.println("copyFldOffset()");
    ...
    */
    ...
    {
        //System.out.println("copyMap(Map fromMap)");
    ...
    public java.lang.String getRowLabel() throws IOException {
        //System.out.println("getRowLabel()");
...
//        return new String(map, map_offset, MAXROWLABELSIZE).trim();
    ...
    */
    public Map setRowLabel(java.lang.String val) throws IOException {
        //System.out.println("setRowLabel(java.lang.String val)");
...
*/
    public Map setColumnLabel(java.lang.String val) throws IOException {
        //System.out.println("setColumnLabel(java.lang.String val) throws IOException ");
...
//        return Convert.getIntValue(map_offset + MAXROWLABELSIZE + MAXCOLUMNLABELSIZE, map);
    ...
    */
    public Map setTimeStamp(int val) throws IOException {
        //System.out.println(" Map setTimeStamp(int val) throws IOException");
    ...
    */
    public Map setValue(java.lang.String val) throws IOException {
        //System.out.println("setValue(java.lang.String val) throws IOException ");
...
//        return map_length;
    ...
    {
        //System.out.println(" tupleCopy(Map fromTuple)");
...
//       fldOffset = fromTuple.copyFldOffset();
    ...
    */
    ...
    {
        //System.out.println("mapSet(byte[] frommap, int offset)");
    ...
    */
    ...
    {
        //System.out.println(" Map mapInit(byte[] amap, int offset)");
        this.map = amap;
        this.map_offset = offset;
...
//        setFldCnt(Convert.getShortValue(offset,this.map));
    ...
    private void initFieldOffset() throws IOException {
        //System.out.println("initFieldOffset()");
