 ...
 public JoinsDriver() {
   ...
   */
   ...
   for (int i=0; i<numsailors; i++) {
     try {
	t.setIntFld(3, ((Sailor)sailors.elementAt(i)).sid);
	t.setStrFld(1, ((Sailor)sailors.elementAt(i)).sname);
...
//    }
 ...
 public void Query2() {
   ...
   System.out.println("Printed values from insput stream 1:"+printcount);
