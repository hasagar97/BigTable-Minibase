...
//        sailors.addElement(new Sailor(69, "Raghu ", 9, 37.1));
//        sailors.addElement(new Sailor(71, "Guri Sohi",         10, 42.1));
//        sailors.addElement(new Sailor(73, "Prasoon ",     8, 39.2));
//        sailors.addElement(new Sailor(39, "Anne Condon",        3, 30.3));
//        sailors.addElement(new Sailor(47, "Charles ",    6, 46.3));
...
////      try {
//// 	t.setIntFld(3, ((Boats)boats.elementAt(i)).bid);
...
////      try {
//// 	t.setIntFld(3, ((Reserves)reserves.elementAt(i)).sid);
//// 	t.setIntFld(3, ((Reserves)reserves.elementAt(i)).bid);
...
////      System.out.println("Recieved temp from filescan");
////      temp.print();
////    }
////    catch (Exception e) {
////      status = FAIL;
...
////    }
//
////    boolean print_join_output = false;
////    if(print_join_output) {
////    t = null;
////     int printcount=0;
////       try {
...
////       }
////     catch (Exception e) {
////      System.err.println ("*** Error printing the joined maps");
////      System.err.println (""+e);
////      Runtime.getRuntime().exit(1);
////    }
//
////    System.out.println("JoinTest: Printed values from join output:"+printcount);
////   }
//
//
//// //     NestedLoopsJoinMap nlj2 = null ;
//// //    try {
//// //      nlj2 = new NestedLoopsJoinMap (Jtypes, 2, Jsizes,
//// // 				   Btypes, 3, Bsizes,
//// // 				   10,
//// // 				   nlj, "boats.in",
...
//// // 			     (iterator.Iterator) nlj2, 1, ascending, JJsize[0], 10,6);
//// //    }
//// //    catch (Exception e) {
//// //      System.err.println ("*** Error preparing for nested_loop_join");
//// //      System.err.println (""+e);
...
////
////    int printcount;
////     boolean print_btt_tree = false;
////     if(print_btt_tree) {
////         t = null;
////         printcount = 0;
////         try {
////             while ((t = id_xx.get_next()) != null) {
////                 //    t.print(JJtype);
////                 t.print();
////                 printcount++;
////                 //    qcheck2.Check(t);
...
//        }
//
//        boolean print_join_output = true;
//        if(print_join_output) {
//            t = null;
//            printcount=0;
//            try {
...
////
////
////     NestedLoopJoinMap inl = null;
////     try {
////	inl = new NestedLoopJoinMap(Stypes, 4, Ssizes,
////				    Rtypes, 3, Rsizes,
////				    10,
////				  am, "reserves.in",
////				    outFilter, null, proj1, 2);
...
////     NestedLoopJoinMap nlj = null;
////     try {
////	nlj = new NestedLoopJoinMap(Jtypes, 2, Jsizes,
////				    Btypes, 3, Bsizes,
////				    10,
////				    inl, "boats.in",
////				    outFilter2, null, proj2, 1);
...
////     try {
////	sort_names = new Sort (JJtype,(short)1, JJsize,
////			       (iterator.Iterator) nlj, 1, ascending, JJsize[0], 10,6);
////     }
////     catch (Exception e) {
